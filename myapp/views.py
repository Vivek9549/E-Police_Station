    ...
    if request.method == 'POST':
        try:
            ...
            if request.POST['password'] == request.POST['rpassword']:
                ...
                subject = 'Welcome to the Metropolitan Police Service'
                message = f'Hi!   You are completing new account e-mail verification. Your verification code is : {otp}. Please complete the account verification process.'
